...
from adaflow.policy.diffusion_unet_image_policy import DiffusionUnetImagePolicy
...
class TrainDiffusionUnetImageWorkspace(BaseWorkspace):
    ...
    def get_evaluate_only_dir(self): 
        return os.path.join(self.output_dir, f"eval_{self.cfg.evaluate_mode}_inference_step={self.cfg.policy.num_inference_steps}")